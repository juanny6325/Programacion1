...
//var rock= mapa.addTilesetImage("Rock","Rocas")
//var rocktower= mapa.addTilesetImage("Rock Tower","torreroca")  
////var solidos= mapa.createDynamicLayer("solidos",tilesets,0,0) 
//var solidos= mapa.createDynamicLayer("solidos",rock,0,0)  
//var solidos= mapa.createDynamicLayer("solidos",rocktower,0,0)    
     ...
     platforms = this.physics.add.staticGroup();
        ...
        player = this.physics.add.sprite(270,610,"jugador")
        player.herido=false 
       ...
       */
        ...
        this.scorevida2 = this.add.text(435, 8, "3", {fontSize: "28px", fill: "#FFFFFF"});
        this.scorevida2.scrollFactorX = 0;
        this.scorevida2.scrollFactorY = 0;
        
       /* this.add.image(4200,650,"portal").setScale(0.50)
        sig =this.add.image(4200,650, "portal").setScale(0.50)
        sig.setInteractive()
        //sig.on('pointerdown', () => sonido.play() );
        sig.on('pointerdown', () => this.scene.start('Nivel2') );   
        */

       /* this.enemigos_walk= this.add.sprite(800,610,"enemigos").setScale(0.25)
        this.enemigos_anim= this.cache.json.get("enemigo_anim");

        this.anims.fromJSON(this.enemigos_anim);
        this.enemigos_walk.anims.play("walk");
