...
create() { 
    ...
    scoreText = this.add.text(800, 40, "CREADORES", {fontSize: "128px", fill: "#FFFFFF"});
    scoreText = this.add.text(800, 250, "MATEO LIOTTA", {fontSize: "128px", fill: "#FFFFFF"});
    scoreText = this.add.text(800, 500, "JUAN FESSIA", {fontSize: "128px", fill: "#FFFFFF"});
